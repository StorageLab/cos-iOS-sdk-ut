...
- (void)testCreate_Get_List_Delete_directory {
    ...
    self.client.completionHandler = ^(COSTaskRsp *resp, NSDictionary *context) {
        ...
        XCTAssert(resp.retCode == 0,@"creating directory ret code is not equal to zero, it is %i actually.",resp.retCode);
        [expectation fulfill];
    };
...
//        XCTAssert(resp.retCode == 0,@"listing directory ret code is not equal to zero, it is %i actually.",resp.retCode);
...
//    [self waitForExpectationsWithTimeout:80 handler:nil];
    ...
    weakSelf.client.completionHandler = ^(COSTaskRsp *resp, NSDictionary *context) {
        ...
        XCTAssert(resp.retCode == 0,@"delete diretroy ret code is not equal to zero, it is %i actually.",resp.retCode);
